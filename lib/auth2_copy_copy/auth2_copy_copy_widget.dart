...
import 'auth2_copy_copy_model.dart';
export 'auth2_copy_copy_model.dart';

class Auth2CopyCopyWidget extends StatefulWidget {
  const Auth2CopyCopyWidget({super.key});

  @override
  State<Auth2CopyCopyWidget> createState() => _Auth2CopyCopyWidgetState();
}

class _Auth2CopyCopyWidgetState extends State<Auth2CopyCopyWidget>
    with TickerProviderStateMixin {
  late Auth2CopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Auth2CopyCopyModel());
