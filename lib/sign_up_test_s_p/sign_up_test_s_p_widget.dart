                              ...
                              child: Column(
                                ...
                                children: [
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          errorBorder: OutlineInputBorder(
                                            borderSide: BorderSide(
                                              color: _model.nameTextController
                                                          .text ==
                                                      functions.newCustomFunction4(
                                                          _model
                                                              .nameTextController
                                  ...
                                  FlutterFlowDropDown<String>(
                                    controller: _model
                                            .profissionDropDownValueController ??=
                                        FormFieldController<String>(null),
                                    options: const ['كهرائي', 'سباك', 'تكييف'],
                                    onChanged: (val) => safeSetState(() =>
                                        _model.profissionDropDownValue = val),
                                    width: double.infinity,
                                    height: 40.0,
                                    ...
                                    fillColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    elevation: 2.0,
                                    borderColor: const Color(0x44262D34),
                                    borderWidth: 1.0,
                                    borderRadius: 8.0,
                            ...
                            child: FFButtonWidget(
                              onPressed: ((_model.nameTextController.text == '') ||
                                      ...
                                      (_model.locationTextController.text ==
                                              '') ||
                                      (_model.profissionDropDownValue == null ||
                                          _model.profissionDropDownValue ==
                                              '') ||
                                      ...
                                      (_model.emailAddressTextController.text !=
                                          functions.validateEmail(_model
                                              ...
                                              .text)) ||
                                      (_model.passwordTextController.text !=
                                          functions.validatePassword(_model.passwordTextController.text)) ||
