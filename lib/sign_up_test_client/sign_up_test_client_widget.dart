...
class SignUpTestClientWidget extends StatefulWidget {
  const SignUpTestClientWidget({super.key});

  @override
  State<SignUpTestClientWidget> createState() => _SignUpTestClientWidgetState();
}

class _SignUpTestClientWidgetState extends State<SignUpTestClientWidget>
    with TickerProviderStateMixin {
  late SignUpTestClientModel _model;
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    enabledBorder: OutlineInputBorder(
                                      borderSide: BorderSide(
                                        color: _model.displayNameTextController
                                                    .text !=
                                                functions.newCustomFunction4(
                                                    _model
                                                        .displayNameTextController
