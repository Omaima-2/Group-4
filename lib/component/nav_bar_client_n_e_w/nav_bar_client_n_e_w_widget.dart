...
class NavBarClientNEWWidget extends StatefulWidget {
  const NavBarClientNEWWidget({
    super.key,
    required this.page,
  });
  ...
  @override
  State<NavBarClientNEWWidget> createState() => _NavBarClientNEWWidgetState();
}

class _NavBarClientNEWWidgetState extends State<NavBarClientNEWWidget> {
  late NavBarClientNEWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavBarClientNEWModel());
