...
class SignupClientWidget extends StatefulWidget {
  const SignupClientWidget({super.key});

  @override
  State<SignupClientWidget> createState() => _SignupClientWidgetState();
}

class _SignupClientWidgetState extends State<SignupClientWidget>
    with TickerProviderStateMixin {
  late SignupClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupClientModel());
