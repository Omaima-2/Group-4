...
class SettingSPWidget extends StatefulWidget {
  const SettingSPWidget({super.key});

  @override
  State<SettingSPWidget> createState() => _SettingSPWidgetState();
}

class _SettingSPWidgetState extends State<SettingSPWidget> {
  late SettingSPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingSPModel());
