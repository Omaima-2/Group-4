...
import 'signin_t_e_s_t_model.dart';
export 'signin_t_e_s_t_model.dart';

class SigninTESTWidget extends StatefulWidget {
  const SigninTESTWidget({super.key});

  @override
  State<SigninTESTWidget> createState() => _SigninTESTWidgetState();
}

class _SigninTESTWidgetState extends State<SigninTESTWidget>
    with TickerProviderStateMixin {
  late SigninTESTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SigninTESTModel());
